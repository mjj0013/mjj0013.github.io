...
function SymbolDecomp() {
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="foundation"   d='${bank.foundation}'  fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round"  stroke-width="2%">
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="column1"  d='${bank.column1}'  fill="rgba(0,0,0,1.0)" stroke="black"  stroke-width="2%"> 
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="column2" d='${bank.column2}'  fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round" stroke-width="2%" > 
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="column3" d='${bank.column3}' fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round" stroke-width="2%" > 
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="column4"  d='${bank.column4}'  fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round" stroke-width="2%"> 
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="floor"  d='${bank.floor}' fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round" stroke-width="2%"> 
  ...
  bankDemo.insertAdjacentHTML("beforeend",
        `<path id="ceiling" d='${bank.ceiling}'  fill="rgba(0,0,0,1.0)" stroke="black" stroke-linejoin="round" stroke-width="2%">
